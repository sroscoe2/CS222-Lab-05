...
| Salaried            | `Salary`    | Annual salary                                                                                  | 20% / 52?????                                                    | 52??? Salary, minus taxes, with post-tax $100 benefit allowance | All salaried employees have a base annual salary.                                               |
| Hourly (general)    | n/a         | Hourly pay rate multiplied by hours worked.<br>(For example, $15/hour rate for 5 hours worked) | n/a                                                              | see Employee (general)                                          | Hourly employees have a per-hour pay rate.                                                      |
